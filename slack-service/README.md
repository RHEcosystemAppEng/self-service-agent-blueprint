...
2.  **Run the installation command:**
    ...
    make install NAMESPACE=<Your-namespace> \
      ...
      LLM_URL=http://llama-3-1-8b-instruct-predictor.kickstart-llms.svc.cluster.local:8080 \
      SAFETY=llama-guard-3-8b \
      SAFETY_URL=http://llama-guard-3-8b-predictor.kickstart-llms.svc.cluster.local:8080
    ```
