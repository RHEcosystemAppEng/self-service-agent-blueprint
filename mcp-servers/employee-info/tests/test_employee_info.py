...
def test_employee_data_structure():
    ...
    required_fields = ["employee_id", "name", "department", "email", "laptop", "it_contact"]
    for field in required_fields:
        assert field in result
    
    laptop_fields = ["brand", "model", "serial_number", "assignment_date", "warranty_expiry", "warranty_status", "specs"]
