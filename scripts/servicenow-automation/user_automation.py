...
class ServiceNowUserAutomation:
    ...
    def assign_roles(self, user_sys_id: str) -> None:
        ...
        # Basic roles needed for API access
        roles_to_assign = [
            'rest_service',  # For REST API access
            'catalog_manager',  # For Service Catalog management
            'api_analytics_read'  # For API analytics
        ]
        ...
        for role_name in roles_to_assign:
            try:
                ...
                role_params = {'sysparm_query': f'name={role_name}', 'sysparm_fields': 'sys_id'}
