...
2. Login into the developer hub -> Click "Request Instance" -> Select "Yokohama" as the instance release version. Note: it may take a few minutes until your new instance is available.
